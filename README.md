...
2. **token-eater does the cleanup** in an isolated copy of your project and checks the result, using your project's own tests/type-check when it has them, or an AI code review when it doesn't (clearly labeled either way).
